...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        GRTL_CS, GRTL_SS, GRTL_CC, GRTL_CA, GRTL_RVS, GRTL_RHS, GRTL_IC, GRTL_IS, GRTL_MOE, GRTL_SO, GRTL_R,
        GRT_VAL_5, GRT_VAL_4, GRT_VAL_2, GRT_OFF, GRT_ON, GRT_OFF, GRT_ON, GRT_ON, GRT_ON, GRT_OFF, GRT_R0,
