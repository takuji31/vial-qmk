...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        GRTL_CS, GRTL_SS, GRTL_CC, GRTL_TS, GRTL_CA, GRTL_RVS, GRTL_RHS, GRTL_IC, GRTL_IS, GRTL_MOE, GRTL_SO, GRTL_R,
        GRT_SPD_5, GRT_SPD_5, GRT_SPD_2, GRT_SPD_5, GRT_OFF, GRT_ON, GRT_OFF, GRT_ON, GRT_ON, GRT_ON, GRT_OFF, GRT_R0,
